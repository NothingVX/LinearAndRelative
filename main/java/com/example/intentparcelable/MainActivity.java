    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Krisna Riyadi");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 17);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Krisna Riyadi");
                mPerson.setAge(16);
                mPerson.setEmail("krisnariyadi101@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "082130440284";
